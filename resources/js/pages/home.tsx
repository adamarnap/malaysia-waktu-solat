            ...
            <div className="flex flex-col space-y-8 text-center">
              <div className="space-y-6">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-300">
                  ...
                  <a
                    className="font-semibold text-pink-500 hover:text-pink-400 dark:text-pink-300 dark:hover:text-pink-200"
                    href="/locations"
                  >
                    locations
                  </a>{" "}
              ...
              <div className="space-x-4">
                ...
                >
                  ...
                  <ChevronRight className="h-4 w-4 translate-x-1 group-hover:translate-x-2 transition" />
                </a>
                <Link
                  href="/health"
